          ...
          <div className="flex flex-col gap-4 items-center md:items-start">
            ...
            <form className="flex flex-col items-center md:items-start gap-2">
              <input
                ...
                className="p-3 rounded bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-600 w-full md:w-60"
              />
              <button
                type="submit"
                className="bg-gray-800 text-white py-2 px-4 rounded hover:bg-gray-600 transition-colors w-full md:w-60"
              >
                Subscribe
              </button>
            </form>
